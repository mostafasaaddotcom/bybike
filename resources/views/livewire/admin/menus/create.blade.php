<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold dark:text-white">Create Menu</h1>
        <p class="text-sm text-zinc-600 dark:text-zinc-400">Add a new menu and attach product variants</p>
    </div>
    ...
    <form wire:submit="create" class="space-y-8">
        ...
        <div class="flex items-center justify-end gap-3">
            ...
            <flux:button type="submit" variant="primary">
                <span wire:loading.remove wire:target="create">Create Menu</span>
