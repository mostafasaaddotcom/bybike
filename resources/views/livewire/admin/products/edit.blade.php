<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold dark:text-white">Edit Product</h1>
        <p class="text-sm text-zinc-600 dark:text-zinc-400">Update product information, variants and pricing</p>
    </div>
    ...
    <form wire:submit="update" class="space-y-8">
        <div class="bg-white dark:bg-zinc-800 rounded-lg shadow p-6 space-y-6">
            ...
            <flux:select wire:model="category_id" label="Category" placeholder="Select a category" required>
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <flux:select wire:model="brand" label="Brand" placeholder="Select a brand">
            ...
            @foreach($variants as $variantIndex => $variant)
                <div wire:key="variant-{{ $variantIndex }}" class="border border-zinc-200 dark:border-zinc-700 rounded-lg p-4 space-y-4">
                    ...
                    <div>
                        ...
                        @if(($variant['existing_image'] ?? null) && !($variant['image'] ?? null))
                            <div class="mb-2">
                                <img src="{{ asset('storage/' . $variant['existing_image']) }}" alt="Current variant image" class="h-24 w-24 object-cover rounded">
                                <p class="text-sm text-zinc-500 dark:text-zinc-400 mt-1">Current image</p>
                            </div>
                        @endif
                        <input
