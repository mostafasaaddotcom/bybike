<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-sm text-zinc-600 dark:text-zinc-400">Manage your event products and their variants</p>
        </div>
        <flux:button variant="primary" href="/admin/products/create" wire:navigate>
            Create Product
        </flux:button>
    </div>
                    ...
                    <tr wire:key="product-{{ $product->id }}" class="hover:bg-zinc-50 dark:hover:bg-zinc-700/50">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div class="text-sm text-zinc-500 dark:text-zinc-400">{{ Str::limit($product->description, 50) }}</div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex items-center justify-end gap-2">
                                <flux:button size="sm" href="/admin/products/{{ $product->id }}/edit" wire:navigate>
                                    Edit
                                </flux:button>
                                <flux:button
                                    size="sm"
                    ...
                    <tr>
                        <td colspan="6" class="px-6 py-12 text-center">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <flux:button variant="primary" href="/admin/products/create" wire:navigate class="mt-4">
