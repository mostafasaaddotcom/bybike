<div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold dark:text-white">Edit Invoice</h1>
        <p class="text-sm text-zinc-600 dark:text-zinc-400">Update invoice #{{ $invoice->invoice_number }}</p>
    </div>
    ...
    <form wire:submit="update" class="space-y-6">
        <div class="bg-white dark:bg-zinc-800 rounded-lg shadow p-6 space-y-6">
            ...
            <flux:select wire:model.live="event_id" label="Event" placeholder="Select an event" required>
